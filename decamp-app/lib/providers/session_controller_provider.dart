...
final sessionControllerProvider =
    FutureProvider.autoDispose<SessionController?>((ref) async {
...
final controllerSessionsProvider = StreamProvider.autoDispose<List<Session>>((
  ref,
) async* {
...
final controllerArchivedSessionsProvider =
    StreamProvider.autoDispose<List<Session>>((ref) async* {
      final controllerAsync = ref.watch(sessionControllerProvider);
...
final controllerMessagesProvider = StreamProvider.autoDispose
    .family<List<Message>, String>((ref, sessionId) async* {
      final controllerAsync = ref.watch(sessionControllerProvider);
