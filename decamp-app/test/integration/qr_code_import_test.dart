...
void main() {
  ...
  group('QR Code Import Integration Tests', () {
    ...
    test('Import QR code with only LLM settings to project', () async {
      ...
      final initialModels = container.read(projectLlmSettingsProvider(testProjectId));
      expect(initialModels, isEmpty, reason: 'Project should start with no LLM models');
      ...
      final updatedModels = container.read(projectLlmSettingsProvider(testProjectId));
      print('Updated models count: ${updatedModels.length}');
      
      if (updatedModels.isEmpty) {
        fail('Project should have LLM models after import, but has ${updatedModels.length}');
      }
      ...
      final notifier = container.read(projectLlmSettingsProvider(testProjectId).notifier);
