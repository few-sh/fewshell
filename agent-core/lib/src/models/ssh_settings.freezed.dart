...
class _$SshSettingsImpl implements _SshSettings {
  ...
  @override
  String toString() {
    return 'SshSettings(host: $host, port: $port, username: $username, authMethod: $authMethod, passwordSecretId: $passwordSecretId, privateKeySecretId: $privateKeySecretId, passphraseSecretId: $passphraseSecretId, sudoPasswordSecretId: $sudoPasswordSecretId, enabled: $enabled)';
  }
...
abstract class _SshSettings implements SshSettings {
  const factory _SshSettings(
      ...
      final String? passphraseSecretId,
      final String? sudoPasswordSecretId,
      final bool enabled}) = _$SshSettingsImpl;
